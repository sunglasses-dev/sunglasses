...
def _stat_or_absent(path):
    ...
    raised PermissionError out of the loader instead, which no caller caught).
    Each loader read False as "never installed" and the control went off with
    nothing on screen (T9 ruling 59, Q4).
    """
    try:
