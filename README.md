...
_All performance numbers verified against `stats/current.json` (v0.2.41, updated Apr 22, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.2.41)

- ✅ Text scanning: 671 patterns, 3,303 keywords, 23 languages, 55 attack categories
