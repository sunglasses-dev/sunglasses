...
_All performance numbers verified against `stats/current.json` (v0.2.35, updated Apr 22, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.2.35)

- ✅ Text scanning: 577 patterns, 2,296 keywords, 23 languages, 54 attack categories
