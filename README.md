...
_All performance numbers verified against `stats/current.json` (v0.3.13, updated Aug 7, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.3.13)

- ✅ Text scanning: 1184 patterns, 7,668 keywords, 23 languages, 109 attack categories
