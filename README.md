...
_All performance numbers verified against `stats/current.json` (v0.3.15, updated Aug 9, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.3.15)

- ✅ Text scanning: 1205 patterns, 7,687 keywords, 23 languages, 116 attack categories
