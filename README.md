...
_All performance numbers verified against `stats/current.json` (v0.2.47, updated Apr 22, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.2.47)

- ✅ Text scanning: 784 patterns, 4,659 keywords, 23 languages, 55 attack categories
