...
_All performance numbers verified against `stats/current.json` (v0.3.14, updated Aug 8, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
