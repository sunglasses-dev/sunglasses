...
| False-positive rate | 0 on the clean-code regression corpus (was 8.3% through v0.2.69; root-caused and fixed in v0.2.69, zero-FP gate enforced in CI every release) |
| Core dependencies | Zero for text scan; optional deps for media |
| Platforms | Mac, Windows, Linux — anywhere Python runs |

_All performance numbers verified against `stats/current.json` (v0.2.69, updated Jun 11, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.2.69)

- ✅ Text scanning: 1076 patterns, 7,738 keywords, 23 languages, 65 attack categories
