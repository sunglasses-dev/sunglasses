...
_All performance numbers verified against `stats/current.json` (v0.4.0, updated Aug 12, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
- ✅ Text scanning: 1350 patterns, 6,645 keywords, 23 languages, 116 attack categories
