...
_All performance numbers verified against `stats/current.json` (v0.2.59, updated Apr 22, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.2.59)

- ✅ Text scanning: 943 patterns, 6,455 keywords, 23 languages, 61 attack categories
