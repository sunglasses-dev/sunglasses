...
_All performance numbers verified against `stats/current.json` (v0.2.60, updated Apr 22, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.2.60)

- ✅ Text scanning: 956 patterns, 6,612 keywords, 23 languages, 63 attack categories
