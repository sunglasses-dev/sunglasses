...
_All performance numbers verified against `stats/current.json` (v0.2.19, updated Apr 21, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.2.19)

- ✅ Text scanning: 313 patterns, 2,019 keywords, 23 languages, 49 attack categories
