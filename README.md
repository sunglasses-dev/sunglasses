...
_All performance numbers verified against `stats/current.json` (v0.2.72, updated Jun 11, 2026). Measured on Apple M3 Max, 48GB RAM, single-threaded Python 3.11. Your hardware will differ._
...
## What Works Today (v0.2.72)

- ✅ Text scanning: 1103 patterns, 7,738 keywords, 23 languages, 65 attack categories
